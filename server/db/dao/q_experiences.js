...
/**
 * Get all experiences by id that are still active in db
 * @param (number) id, the user id
 * @return (Promise<{}>) A promise of all the experiences pertaining to the user
 */
export const getExperiencesByUserId = id => {
  let query = `
  SELECT
  *
FROM
